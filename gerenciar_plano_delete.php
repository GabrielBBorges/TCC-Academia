...
<html>
<head>
    <title>Deletar Plano - Live Fitness</title>
...
<body>
    ...
    <section class="container-2 alunos-table">
        <header class="titulo">
            <h1>Confirma a exclusão deste plano?</h1>
        </header><br>
            ...
            <?php 
                ...
                $plano = $SelectIDPlano->SelectIDPlano($_GET["tdp_cod"]);
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>";
                            echo $plano['tdp_valor']; 
                        echo "</td>";

                        echo "<td>";
                            echo $plano['tdp_caract']; 
                        echo "</td>";  
                    echo "</tr>";                   
            ?>
        </table>
        <form action="controle.php" method="post">
            <input type="hidden" name="acao" value="DeletarPlano"/>
