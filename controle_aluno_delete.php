...
<html>
<head>
    <title>Controle de Alunos - Live Fitness</title>
...
<body>
    ...
    <section class="container-2 alunos-table">
        <header class="titulo">
            <h1>Confirma a exclusão desta matrícula?</h1>
        </header><br>
       ...
       <table class="table">
            ...
            <?php 
                ...
                $usuario = $SelectID->SelectID($_GET["cli_matric"]);
                    ...
                    echo "<tr>";
                        echo "<td>";
                            echo $usuario['cli_matric']; 
                        echo "</td>";

                        echo "<td>";
                            echo $usuario['cli_nome']; 
                        echo "</td>";

                        echo "<td>";
                            echo $usuario['cli_email']; 
                        echo "</td>";

                        echo "<td>";
                            echo $usuario['cli_endereco']; 
                        echo "</td>";

                        echo "<td>";
                            echo $usuario['cli_tel']; 
                        echo "</td>";   
                    echo "</tr>";                   
            ?>
        </table>
