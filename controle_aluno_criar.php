...
<html>
<head>
    <title>Matrícula NOVO aluno - Admin</title>
...
<body>
    ...
    <section class="container">
        <form method="POST" action="planos-cliente.php" class="form-container" id="matricula">
            ...
            <input type="name" name="txtName" required="" maxlength="15" placeholder="Nome" autofocus="" pattern="[a-zA-Záãâéêíîóôõú\s]+$">
            <br>
            ...
            <input type="hidden" name="gerenciar_aluno" value="Sim"> 
        </form>
    </section>
    <br><br>
</body>
