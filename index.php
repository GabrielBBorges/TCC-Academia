...
<body>
	...
	<section class="modalidades container">
		...
		<article class="item">
			<h2>Musculação</h2>
			<p>É um conjunto de exercícios físicos, que visa os fortalecimentos e desenvolvimentos dos músculos esqueléticos.</p><br>
			<a href="Telamodalidades.php"><button type="submit" class="botao">Saiba Mais!</button></a>
		</article>
		<article class="item">
			<h2>GAP Funcional</h2>
			<p>Aula em grupo de treinamento de alta intensidade e curta duração, desenvolve o condicionamento através de circuitos com exercícios.</p>
			<a href="Telamodalidades.php"><button type="submit" class="botao">Saiba Mais!</button></a>
		</article>
		<article class="item">
			<h2>Pilates</h2>
			<p>Método de condicionamento físico, que promove harmonia e balanço muscular para todas as idades e saúde física direcionada às necessidades individuais da pessoa</p>
			<a href="Telamodalidades.php"><button type="submit" class="botao">Saiba Mais!</button></a>
		</article>
		<article class="item">
			<h2>Ballet</h2>
			<p>Dança artística apresentada por vários bailarinos que, num cenário, com acompanhamento de música, dançam com graça e precisão de técnica. </p>
			<a href="Telamodalidades.php"><button type="submit" class="botao">Saiba Mais!</button></a>
		</article>
		<article class="item">
			<h2>Jiu Jitsu</h2>
			<p>É uma arte marcial, onde usa-se a força e o peso do adversário contra ele, sendo permitido, inclusive, lançar o adversário em queda.</p><br>
			<a href="Telamodalidades.php"><button type="submit" class="botao">Saiba Mais!</button></a>
		</article>
